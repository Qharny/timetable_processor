// import 'dart:io';
// import 'package:timetable_processor/services/file_services.dart';
...
void main(List<String> arguments) async {
  ...
  try {
    print('Welcome to Timetable Processor!');
    print('1. Select input file');
    print('2. Process and validate data');
    print('3. Export to desired format');
    print('4. Exit');
      ...
      switch (choice) {
        ...
        case '3':
          if (parserService.processedData != null) {
            ...
            print('Please process a file first!');
          }
          break;
        case '4':
          running = false;
